...
class AlunoEscolaA{
	...
	//Objetos
	//Publico podemos aceder os dados de qualquer lugar dentro e fora da classe
	public:
	...
	//Só podemos aceder os dados dentro da própria classe
	private:
	...
	//Podemos aceder os dados dentro da própria classe e também de classes herdadas	
	protected:
